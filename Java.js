...
const setup = () => {
    ...
    infoBtn.onclick = () => alert("GOOD YOU FOUND THIS BUTTON click once on the screen to pause the drawing, click twice to restart you can also zoom in amd out. i love you");
